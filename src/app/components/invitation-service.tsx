...
const translations = {
  ...
  en: {
    ...
    rsvpNoToast: "Sorry — we'll miss you! 🥺",
  ...
  es: {
    ...
    rsvpNoToast: "¡Qué pena, te echaremos de menos! 🥺",
  ...
  az: {
    ...
    guestWillSee: "Dəvətnamənin önizləməsi:",
    rsvpTitle: "Şənliyə gələcəksinizmi?",
    rsvpYes: "Gələcəyik",
    ...
    viewPreview: "Önizləməyə bax",
    changeResponse: "Cavabı dəyiş"
  }
};
const emojiOptions = ["🎉", "🎂", "🎈", "🎁", "🚀", "🦊", "👾", "🦖", "🦄", "👑", "🍕", "🧁"];
